...
def get_okex_candle_data(exchange, symbol, time_interval):
    # 抓取数据
    content = exchange.fetch_ohlcv(symbol, timeframe=time_interval, since=0, limit=10)
...
# 自动发送邮件
def auto_send_email(to_address, subject, content, from_address='861574834@qq.com', if_add_time=True):
    """
    :param to_address:
    :param subject:
    :param content:
