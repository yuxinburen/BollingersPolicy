...
import ccxt
from code.Trade import next_run_time, place_order, get_okex_candle_data, auto_send_email
from code.Signals import signal_moving_average
...
exchange.secret = 'vEUa0hyVB8YEKRWu1QONX4b139KAKpJPawAn8uiXgfu'
exchange.headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:23.0) Gecko/20100101 Firefox/23.0'}
...
while True:
    ...
    if run_time.minute % 30 == 0:
        # 发送邮件
        auto_send_email('861574834@qq.com', email_title, email_content)
